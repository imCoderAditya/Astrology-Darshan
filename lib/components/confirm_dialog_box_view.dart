...
class _ConfirmationContent extends StatefulWidget {
  ...
  final String consultationType; // 'Paid' or 'Free'
  final String type;
  final double rate;
...
class _ConfirmationContentState extends State<_ConfirmationContent>
  ...
  bool get isPaid => widget.consultationType.toLowerCase() == 'paid';
  bool get isFree => widget.consultationType.toLowerCase() == 'free';

  // Calculate maximum talk time based on wallet balance
  double get maxTalkTimeInMinutes {
    // For free consultation (both chat and call), limit to 5 minutes
    if (isFree) return 5.0;
  ...
  bool get hasSufficientBalance {
    if (isFree) return true; // Free consultation always has sufficient balance
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                _buildHeader(),
                _buildContent(),
                if (isPaid && !hasSufficientBalance) _buildInsufficientBalanceWarning(),
                if (isPaid && !hasSufficientBalance) SizedBox(height: 20.h),
                _buildButtons(),
              ],
            ),
          ),
    ...
    return Padding(
      ...
      child: Column(
        children: [
          ...
          // Rate Info - Only show for Paid consultations
          if (isPaid) ...[
            Container(
              width: double.infinity,
          ...
          // Free Consultation Info - Only show for Free consultations
          if (isFree) ...[
            Container(
              width: double.infinity,
              ...
              child: Column(
                children: [
                  ...
                  SizedBox(height: 4.h),
                  Text(
                    'Enjoy 5 minutes of free consultation',
                    style: AppTextStyles.caption().copyWith(
          ...
          // Balance and Total Time Display - Only for Paid consultations
          if (isPaid) ...[
            Container(
              width: double.infinity,
              padding: EdgeInsets.all(12.w),
...
//   // Calculate maximum talk time based on wallet balance
//   double get maxTalkTimeInMinutes {
//     if (isFree) return 999.0; // No limit for free consultation
...
//                   SizedBox(height: 4.h),
//                   Text(
//                     'This is a complimentary consultation session',
//                     style: AppTextStyles.caption().copyWith(
//                       color: Colors.green.shade700,
//                     ),
//                     textAlign: TextAlign.center,
