...
class Data {
    ...
    factory Data.fromJson(Map<String, dynamic> json) => Data(
        astrologers: json["astrologers"] == null ? [] : List<Astrologer>.from(json["astrologers"]!.map((x) => Astrologer.fromJson(x))),
        pagination: json["pagination"] == null ? null : Pagination.fromJson(json["pagination"]),
    );

    Map<String, dynamic> toJson() => {
        "astrologers": astrologers == null ? [] : List<dynamic>.from(astrologers!.map((x) => x.toJson())),
