...
class AstrologersView extends GetView<AstrologersController> {
  ...
  Widget astrollerListView(bool isDark, AstrologersController controller) {
    return Container(
      ...
      child:
          controller.isLoading.value && controller.astrologerList.isEmpty
              ? _buildLoadingState()
              : controller.astrologerList.isEmpty
              ? _buildEmptyState()
              : ListView.builder(
          ...
          children: [
            ...
            Container(
              ...
              child: Icon(
                ...
                size: 60.sp,
                color: isDark ? Colors.orange : AppColors.primaryColor,
              ),
            ),
            ...
            // Description
            Text(
              'We couldn\'t find any astrologers matching your criteria. Try adjusting your filters or check back later.',
              style: TextStyle(
                fontSize: 14.sp,
